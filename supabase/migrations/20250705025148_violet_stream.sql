/*
  # Update Returns System to Track Returned Items
  
  1. Changes
    - Add tracking of returned items in detalle_ventas
    - Update process_return function to mark items as returned
    - Improve return processing for better reporting
    - Add support for partial returns tracking
*/

-- Add column to track returned quantities in detalle_ventas
