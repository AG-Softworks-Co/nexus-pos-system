/*
  # Arreglar sistema de descuentos completamente
  
  1. Cambios
    - Desactivar COMPLETAMENTE el trigger que causa totales en $0
    - Permitir que el frontend maneje todos los cálculos
    - Mantener solo funcionalidad de crédito sin tocar totales
...
DROP TRIGGER IF EXISTS handle_credit_sales_only_trigger ON ventas;
