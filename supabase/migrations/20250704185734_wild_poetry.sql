/*
  # Completely permissive RLS policies for pagos_parciales
  
  1. Changes
    - Drop all existing policies for pagos_parciales
    - Create a single permissive policy that allows all operations
    - Ensure the table has RLS enabled but effectively bypassed
*/
...
-- Ensure the update_payment_status function is properly defined
