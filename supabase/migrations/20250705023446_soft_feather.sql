/*
  # Fix Returns System and Error Handling
  
  1. Changes
    - Improve process_return function to handle missing cuentas_credito table
    - Add robust error handling with try/catch blocks
    - Fix issue with relation "cuentas_credito" does not exist error
    - Ensure all operations are wrapped in exception handling blocks
*/
