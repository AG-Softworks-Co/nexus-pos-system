    ...
    <div className="relative ml-auto mr-4" ref={containerRef}>
      ...
      {isOpen && (
        <>
          ...
          {/* Calendar Modal */}
          <div className="fixed top-1/2 right-8 transform -translate-y-1/2 bg-white rounded-2xl shadow-2xl border border-gray-200 p-6 z-[9999] min-w-[420px] max-w-[90vw] max-h-[90vh] overflow-auto">
            {/* Header */}
